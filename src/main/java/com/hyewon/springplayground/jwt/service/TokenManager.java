package com.hyewon.springplayground.jwt.service;

import com.hyewon.springplayground.domain.member.constant.Role;
import com.hyewon.springplayground.global.error.ErrorCode;
import com.hyewon.springplayground.global.error.exception.AuthenticationException;
import com.hyewon.springplayground.jwt.constant.GrantType;
import com.hyewon.springplayground.jwt.constant.TokenType;
import com.hyewon.springplayground.jwt.dto.JwtTokenDto;
...
public class TokenManager {
    ...
    // refresh token 생성 : 리프레시 토큰에는 많은 정보를 담지 않는다.
